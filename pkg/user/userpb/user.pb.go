...
var file_user_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x32, 0xda, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x55, 0x73, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x4c, 0x69, 0x73, 0x74, 0x42,
...
var file_user_proto_depIdxs = []int32{
	...
	11, // 2: pb.Profile.membership_Expiry_Date:type_name -> google.protobuf.Timestamp
	3,  // 3: pb.UserService.UserSignup:input_type -> pb.Signup
	4,  // 4: pb.UserService.VerifyUser:input_type -> pb.OTP
	5,  // 5: pb.UserService.UserLogin:input_type -> pb.Login
	7,  // 6: pb.UserService.ViewProfile:input_type -> pb.ID
	8,  // 7: pb.UserService.EditProfile:input_type -> pb.Profile
	10, // 8: pb.UserService.ChangePassword:input_type -> pb.Password
	7,  // 9: pb.UserService.BlockUser:input_type -> pb.ID
	9,  // 10: pb.UserService.UserGetAllProblems:input_type -> pb.UserNoParam
	6,  // 11: pb.UserService.UserSignup:output_type -> pb.Response
	6,  // 12: pb.UserService.VerifyUser:output_type -> pb.Response
	6,  // 13: pb.UserService.UserLogin:output_type -> pb.Response
	8,  // 14: pb.UserService.ViewProfile:output_type -> pb.Profile
	8,  // 15: pb.UserService.EditProfile:output_type -> pb.Profile
	6,  // 16: pb.UserService.ChangePassword:output_type -> pb.Response
	6,  // 17: pb.UserService.BlockUser:output_type -> pb.Response
	2,  // 18: pb.UserService.UserGetAllProblems:output_type -> pb.UserProblemList
