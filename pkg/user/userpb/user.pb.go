...
var file_user_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x6f, 0x0a, 0x0e, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x72, 0x64, 0x32, 0x82, 0x05, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*InvoiceRequest)(nil),             // 3: pb.InvoiceRequest
	(*UPlanList)(nil),                  // 4: pb.UPlanList
	(*USubscription)(nil),              // 5: pb.USubscription
	(*UserStatsResponse)(nil),          // 6: pb.UserStatsResponse
	(*UserSubmissionResponse)(nil),     // 7: pb.UserSubmissionResponse
	(*UserSubmissionRequest)(nil),      // 8: pb.UserSubmissionRequest
	(*UserTestCase)(nil),               // 9: pb.UserTestCase
	(*UserProblemWithTestCases)(nil),   // 10: pb.UserProblemWithTestCases
	(*UserTestcaseResponse)(nil),       // 11: pb.UserTestcaseResponse
	(*UserProblemId)(nil),              // 12: pb.UserProblemId
	(*UserProblem)(nil),                // 13: pb.UserProblem
	(*UserProblemList)(nil),            // 14: pb.UserProblemList
	(*Signup)(nil),                     // 15: pb.Signup
	(*OTP)(nil),                        // 16: pb.OTP
	(*Login)(nil),                      // 17: pb.Login
	(*Response)(nil),                   // 18: pb.Response
	(*ID)(nil),                         // 19: pb.ID
	(*Profile)(nil),                    // 20: pb.Profile
	(*UserNoParam)(nil),                // 21: pb.UserNoParam
	(*Password)(nil),                   // 22: pb.Password
	(*timestamppb.Timestamp)(nil),      // 23: google.protobuf.Timestamp
}
var file_user_proto_depIdxs = []int32{
	5,  // 0: pb.UPlanList.plans:type_name -> pb.USubscription
	0,  // 1: pb.UserSubmissionResponse.status:type_name -> pb.UserSubmissionResponse.Status
	13, // 2: pb.UserProblemWithTestCases.problem:type_name -> pb.UserProblem
	9,  // 3: pb.UserProblemWithTestCases.test_cases:type_name -> pb.UserTestCase
	1,  // 4: pb.UserTestcaseResponse.status:type_name -> pb.UserTestcaseResponse.Status
	10, // 5: pb.UserTestcaseResponse.data:type_name -> pb.UserProblemWithTestCases
	13, // 6: pb.UserProblemList.problems:type_name -> pb.UserProblem
	2,  // 7: pb.Response.status:type_name -> pb.Response.Status
	23, // 8: pb.Profile.membership_Expiry_Date:type_name -> google.protobuf.Timestamp
	15, // 9: pb.UserService.UserSignup:input_type -> pb.Signup
	16, // 10: pb.UserService.VerifyUser:input_type -> pb.OTP
	17, // 11: pb.UserService.UserLogin:input_type -> pb.Login
	19, // 12: pb.UserService.ViewProfile:input_type -> pb.ID
	20, // 13: pb.UserService.EditProfile:input_type -> pb.Profile
	22, // 14: pb.UserService.ChangePassword:input_type -> pb.Password
	19, // 15: pb.UserService.BlockUser:input_type -> pb.ID
	21, // 16: pb.UserService.UserGetAllProblems:input_type -> pb.UserNoParam
	12, // 17: pb.UserService.UserGetProblemWithTestCases:input_type -> pb.UserProblemId
	8,  // 18: pb.UserService.SubmitCode:input_type -> pb.UserSubmissionRequest
	19, // 19: pb.UserService.GetUserStats:input_type -> pb.ID
	21, // 20: pb.UserService.UserGetAllPlans:input_type -> pb.UserNoParam
	3,  // 21: pb.UserService.GenerateInvoice:input_type -> pb.InvoiceRequest
	18, // 22: pb.UserService.UserSignup:output_type -> pb.Response
	18, // 23: pb.UserService.VerifyUser:output_type -> pb.Response
	18, // 24: pb.UserService.UserLogin:output_type -> pb.Response
	20, // 25: pb.UserService.ViewProfile:output_type -> pb.Profile
	20, // 26: pb.UserService.EditProfile:output_type -> pb.Profile
	18, // 27: pb.UserService.ChangePassword:output_type -> pb.Response
	18, // 28: pb.UserService.BlockUser:output_type -> pb.Response
	14, // 29: pb.UserService.UserGetAllProblems:output_type -> pb.UserProblemList
	11, // 30: pb.UserService.UserGetProblemWithTestCases:output_type -> pb.UserTestcaseResponse
	7,  // 31: pb.UserService.SubmitCode:output_type -> pb.UserSubmissionResponse
	6,  // 32: pb.UserService.GetUserStats:output_type -> pb.UserStatsResponse
	4,  // 33: pb.UserService.UserGetAllPlans:output_type -> pb.UPlanList
	18, // 34: pb.UserService.GenerateInvoice:output_type -> pb.Response
